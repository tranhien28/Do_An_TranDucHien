...
<html lang="en" class="h-100">
  <head>
    ...
    <meta name="description" content="Beptot.vn - Full Stack Web Developer">
    <meta name="author" content="Beptot.vn">
    <title>Beptot.vn - Powerful Ecommerce Platform</title>
  ...
  <body class="d-flex h-100 text-center text-white bg-dark">
    ...
    <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
        ...
        <footer class="mt-auto text-white-50">
            <p>Cover template for <a href="#" class="text-white">Bootstrap</a>, by <a href="#" class="text-white">ad</a>.</p>
        </footer>
    </div>
